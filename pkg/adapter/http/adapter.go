...
//
// It is a manager.Adapter — Run blocks until ctx is done, returning
...
func (a *Adapter) Run(ctx context.Context, host manager.AdapterHost) error {
	if host == nil {
...
func (a *Adapter) mount(host manager.AdapterHost) {
	a.mountMu.Lock()
