...
// ParentID implements [extension.SessionState]. Returns "" for root
// sessions.
...
// SetValue implements [extension.SessionState]. Stores a typed handle
...
// Value implements [extension.SessionState]. Returns (handle, true) if
...
// ParentValue implements [extension.SessionState]. Reads the parent
