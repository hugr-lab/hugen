...
type Session struct {
	...
	// waiting for the next user message. Phase 5.1c.cancel-ux
	// follow-up — dogfood revealed the model would otherwise try to
	// notify_subagent against the just-closed mission. Cleared at
